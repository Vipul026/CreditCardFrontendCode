                            ...
                            <div className="collapse navbar-collapse" id="navbarNavDropdown" style={{ paddingRight: "15px" }}>
                                <ul className="navbar-nav">
                                    {/* <li className="nav-item">
                                        <a className="nav-a active mr-4" aria-current="page" to="" style={{ fontSize: '15px' }}>Home</a>
                                    </li> */}
                            ...
                            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul className="navbar-nav">
                                    ...
                                    {/* <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }} >Add Account</a></li>
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }}>Get All Account</a></li>
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }}>Get Account</a></li>
                                        </ul>
                                    </li> */}
                                    <li className="nav-item dropdown">
                                        <a style={{ fontSize: '15px', color: 'white', paddingRight: '20px' }} className="nav-a dropdown-toggle" href="#" id="navbarDropdownMenua" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }}>Add Transaction</a></li>
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }} > Get All Transaction</a></li>
                                            {/* <li><a className="dropdown-item" to="removeCustomer">Delete Customer</a></li> */}
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }}>Get Transaction</a></li>
                                            {/* <li><a className="dropdown-item" to="updateCustomer">Update Customer</a></li> */}
                                        </ul>
                                    </li>
                                    <li className="nav-item dropdown">
                                        <a style={{ fontSize: '15px', color: 'white', paddingRight: '20px' }} className="nav-a dropdown-toggle" href="#" id="navbarDropdownMenua" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            ...
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }} >Add Credit Card</a></li>
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }} >Get Credit Card</a></li>
                                            {/* <li><a className="dropdown-item" to="removeCustomer">Delete Customer</a></li> */}
                                            <li><a className="dropdown-item" style={{ fontSize: '15px' }}>Get All Credit Card</a></li>
                                            {/* <li><a className="dropdown-item" to="updateCustomer">Update Customer</a></li> */}
                                        </ul>
                                    </li>
                                </ul>
