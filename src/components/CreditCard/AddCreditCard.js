                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3" style={{ opacity: 0.7, fontWeight: "bold", fontSize: 18, backgroundColor: 'black', color: 'white' }} >
                            ...
                            <div className="card-body">
                                <form className="form-group" onSubmit={this.submitHandler}>
                                    ...
                                    <br />
                                    <center>
                                        <button className="btn btn-primary mr-2" style={{marginBottom:'50px'}}>Add  New Credit details</button>
                                        <a href="listOfCreditCard" className="btn btn-danger ml-2" style={{marginBottom:'50px'}}>Cancel</a>
                                    </center>
                                </form>
                            </div>
                        </div>
